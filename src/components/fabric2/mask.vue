...
onMounted(() => setTimeout(() => {
  ...
  var imgInstance = new fabric.Image(img1.value, {
    left: 100,
    top: 100,
    crossOrigin: 'anonymous',
  })
  var imgInstance2 = new fabric.Image(img2.value, {
    left: 100,
    top: 100,
    width: 500,
    crossOrigin: 'anonymous',
  ...
  editorStore.add(imgInstance)

  editorStore.add(imgInstance2)
  imgInstance2.filters?.push(
    new fabric.Image.filters.BlendImage({
      image: imgInstance
    })
  )
  imgInstance2.applyFilters()
